package dev.koicreek.bokasafn.mimir.users.security;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.fasterxml.jackson.databind.ObjectMapper;
import dev.koicreek.bokasafn.mimir.users.model.LoginRequestCM;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
            ...
            Authentication auth) throws IOException, ServletException
    {
        ...
        final String secret = env.getProperty("token.secret");

        Algorithm algoHS = Algorithm.HMAC256(secret != null ? secret : "Walk slowly through the doors of joy.");
