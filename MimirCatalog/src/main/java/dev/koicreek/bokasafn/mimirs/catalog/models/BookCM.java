...
import dev.koicreek.bokasafn.mimirs.catalog.models.converters.csv.acc.ToAuthorCM;
import dev.koicreek.bokasafn.mimirs.catalog.models.converters.csv.abf.ToLanguageEnum;
import dev.koicreek.bokasafn.mimirs.catalog.models.converters.csv.abf.ToPublisherCM;
import dev.koicreek.bokasafn.mimirs.catalog.models.converters.enums.LanguageCodeConverter;
...
public class BookCM {
    ...
    @Convert(converter = LanguageCodeConverter.class)
    @CsvBindAndSplitByName(column = "AdditionalLanguages", splitOn = "\\|+", elementType = Language.class, converter = dev.koicreek.bokasafn.mimirs.catalog.models.converters.csv.acc.ToLanguageEnum.class)
